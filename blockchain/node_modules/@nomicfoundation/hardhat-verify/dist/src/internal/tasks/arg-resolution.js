...
export async function resolveConstructorArgs(constructorArgs, constructorArgsPath) {
    ...
    if (!("default" in importedConstructorArgs) ||
...
export async function resolveLibraries(librariesPath) {
    ...
    // forgets to export the default value and another for when the user
    // exports a value that is not an string[] and throw better errors.
    if (!("default" in importedLibraries) ||
    ...
    return importedLibraries.default;
}
//# sourceMappingURL=arg-resolution.js.map