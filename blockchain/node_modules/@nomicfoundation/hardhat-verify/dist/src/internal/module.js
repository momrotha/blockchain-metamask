...
export async function loadModule(modulePath) {
    ...
    try {
        ...
        if ("code" in error &&
            ...
            throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.VALIDATION.MODULE_NOT_FOUND, { modulePath });
        }
        if (error instanceof SyntaxError) {
            throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.VALIDATION.MODULE_SYNTAX_ERROR, { modulePath, errorMessage: error.message });
        }
        throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.VALIDATION.IMPORT_MODULE_FAILED, { modulePath, errorMessage: error.message });
    }
}
