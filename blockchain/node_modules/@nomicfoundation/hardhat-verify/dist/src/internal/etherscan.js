...
export class Etherscan {
    ...
    async verify({ contractAddress, compilerInput, contractName, compilerVersion, constructorArguments, }) {
        ...
        if (!etherscanResponse.isOk()) {
            throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL
                .CONTRACT_VERIFICATION_REQUEST_FAILED, { message: etherscanResponse.message });
        }
    ...
    async pollVerificationStatus(guid, contractAddress, contractName) {
        ...
        if (!etherscanResponse.isOk()) {
            throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL
                .CONTRACT_VERIFICATION_STATUS_POLLING_FAILED, { message: etherscanResponse.message });
        }
        // Reaching this point shouldn't be possible unless the API is behaving in a new way.
        throw new HardhatError(HardhatError.ERRORS.HARDHAT_VERIFY.GENERAL
            .CONTRACT_VERIFICATION_UNEXPECTED_RESPONSE, { message: etherscanResponse.message });
    }
...
class EtherscanVerificationStatusResponse {
    ...
    isRetryable() {
        ...
        return !NON_RETRYABLE_FAILURE_PATTERNS.some((pattern) => message.includes(pattern));
    }
}
