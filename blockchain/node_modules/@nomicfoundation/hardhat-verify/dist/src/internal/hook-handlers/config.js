...
export async function resolveUserConfig(userConfig, resolveConfigurationVariable, next) {
    ...
    return {
        ...
        verify: {
            ...
            blockscout: resolveBlockscoutConfig(userConfig.verify?.blockscout, resolveConfigurationVariable),
...
function resolveBlockscoutConfig(blockscoutConfig = {
    ...
    return {
        ...
        apiKey: blockscoutConfig.apiKey !== undefined
...
function resolveSourcifyConfig(sourcifyConfig = {
    enabled: true,
}) {
    return {
